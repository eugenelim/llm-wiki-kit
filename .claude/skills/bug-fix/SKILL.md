...
8. **Commit body documents the root cause.** Commit subject in the
   project's format (`v2: task <N> - <summary>` during the v2 migration;
   `fix(<scope>): <subject>` after v2.0.0) plus a body explaining what
