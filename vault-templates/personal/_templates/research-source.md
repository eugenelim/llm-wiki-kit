...
fetched_via: defuddle           # defuddle | pure.md | docling | perplexity | semantic-scholar | gemini | manual
...
citations: []                   # for sources that themselves cite other works (Perplexity, S2)
